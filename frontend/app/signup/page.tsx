...
export default function Signup() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      // The proxy rewrites this to http://localhost:3000/signup
         ...
         <div className="bg-white/[0.03] backdrop-blur-2xl border border-white/10 rounded-[32px] p-8 md:p-12 shadow-2xl opacity-0 animate-[fadeUp_0.6s_ease-out_0.1s_forwards]">
          <header className="text-center mb-8">
            ...
            <p className="text-neutral-400 text-sm">
              Enter your details to register for AuditChain.
            </p>
          </header>
          ...
          <form className="space-y-5" onSubmit={handleSignup}>
            ...
            {/* Password */}
            <div className="space-y-2">
              <label htmlFor="password" className="block text-[10px] font-semibold text-neutral-500 uppercase tracking-[0.2em] ml-1">
                Password
              </label>
              <input
                type="password"
            ...
            <button
              ...
              className="w-full h-12 mt-4 bg-white text-black font-semibold rounded-xl transition-colors hover:bg-neutral-200 disabled:opacity-50 disabled:cursor-not-allowed"
            >
